...
const Product = (props: IProductProps) => {
  ...
  return (
    <div className="w-full relative group border-[1px] shadow-lg">
      ...
      <div className="max-w-80 py-6 flex flex-col gap-1 border-t-0 px-4">
        <div className="flex flex-col items-start justify-between font-titleFont">
          <h2 className="text-lg text-primeColor font-bold">
            {props.productName}
          </h2>
          <p className="gold  text-xl">{props.price} KD</p>
        </div>
        <div>
