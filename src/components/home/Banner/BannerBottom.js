...
export default function BannerBottom() {
  return (
    <div className="2xl:container 2xl:mx-auto md:py-12 py-9">
      <div className=" bg-gray grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-12 py-10 md:px-12 px-4 ">
        {/* Delivery grid Card */}
        <div className="flex flex-col justify-center items-center">
          ...
          <h3 className=" text-xl leading-5 font-semibold text-gray-800  mt-4 ">
            Delivery
          </h3>
          <p className=" text-base leading-6 font-normal text-gray-600 mt-4 lg:w-full md:w-9/12 w-full text-center">
